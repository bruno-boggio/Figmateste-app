...
const CardPlanos = () => {
    return (
       <div className="div-container-planos">
            ...
            <div>
                <h1 className="planos-h1">Conheça nossos planos</h1>
            </div>


         <div className="container-plano-box">  
            <div className="plano-box">
                  ...
                  <div className="box-info">
                       ...
                       <div className="div-box-p">
                        ...
                        <p className="box-p">Os planos e a lista de compras</p>
                        <p className="box-p">serão feitos para auxiliar nos</p>
                        <p className="box-p">objetivo de cada pessoa e</p>
                        <p className="box-p">facilitar a rotina da casa</p>
                        </div>  

                      <div className="box-btn-div">  
                        <button className="box-btn">Começar agora</button>
                      </div> 
